...
- PULU, administrative system to report how we process the data here in the university, to the data protection agency; Filling out an online form;
- 
...
- Only minor changes is possible to happen. If significant changes, one should apply again.
- For international collaborations, only that part is conducted in Sweden should be reviewed. Warning: The data collection abroad should not start before the Swedish Authority has agreed the Swedish part of the research.
- Possible decisions: approval, or approval with conditions, or reject.
- Case by case situation by the authority: in research merely involving the processing of (sensitive) personal data.


# Course 4. Dec. 9th, 2022
## Some general data infrastructure in the university
- LUSEC at lund university to store things, which is the most secure; Distant access, need to pay a fee;
- PULU, administrative service given by the university's data protection office, filling out an online form reporting what one would do to the data;
- Check these out in CANVAS?
- [forskningsetik at lu.se](https://www.medarbetarwebben.lu.se/forska-och-utbilda/stod-till-forskning/forskningsetik-och-djurforsoksetik)
  Research ethics and animal experimentation ethics office in the university
## Consent 
- To be explicit
- To show voluntary: consent, opt-out
- voluntary vs undue influence
- Informed: info, which would be understood and what is actually understood: 
  purpose/aim, what will happen (to me) with risks/burdens, contact info for Qs & complaints, benefits (compensation);
  voluntary(including withdraw), why selected, protection of confidentiality (data storage etc.), dissemination of results,
  expectations requrested (time etc.)

# Course 5, Dec.12, 2022
## Allea code of conduct
- [The link to the file](https://allea.org/code-of-conduct/)
- Contact Christer Joensson to consult for tricks implementing the Good Research Practice in social science.
